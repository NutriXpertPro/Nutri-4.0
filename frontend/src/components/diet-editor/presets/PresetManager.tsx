...
function MealPresetsManagerContent({
  ...
  const handleSavePreset = async () => {
    console.log('[DEBUG handleSavePreset] Iniciando salvamento...');
    console.log('[DEBUG handleSavePreset] isCreating:', isCreating);
    console.log('[DEBUG handleSavePreset] newPreset:', newPreset);
    console.log('[DEBUG handleSavePreset] editingPreset:', editingPreset);

    try {
      const currentPreset = isCreating ? newPreset : editingPreset;
      console.log('[DEBUG handleSavePreset] currentPreset:', currentPreset);
      ...
      if (isCreating) {
        ...
        console.log('[DEBUG handleSavePreset] createMealPreset completado com sucesso!');
        ...
        console.log('[DEBUG handleSavePreset] updateMealPreset completado com sucesso!');
