      ...
      <div className="container px-4 md:px-6 mx-auto">
        ...
        <div className="mb-24 text-center max-w-4xl mx-auto">
          ...
          <p className="text-neutral-400 text-lg">
            O <span className="mr-1 text-white" style={{ textShadow: '1px 1px 2px rgba(255,255,255,0.1)' }}>
            ...
            </span> não é apenas um software de dietas. É um ecossistema completo desenhado para centralizar sua operação clínica e elevar sua autoridade profissional.
          </p>
        </div>
